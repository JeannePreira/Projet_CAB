...
<form class="" >
     ...
     <h1 class="text-center font-weight-bolder">Liste Etudiant</h1>
  



   
    <button style="margin-left:150px" type="submit" class="btn btn-light ml-2 float-right ">Suivante</button>
